...
class JsonModel(QAbstractItemModel):
    ...
    def __init__(self, jsonData : "dict" = {}, parent: QObject = None):
    ...
    def load(self):
        ...
        assert isinstance(
            self.jsonData, (dict, list, tuple)
        ), "`self.jsonData` must be of dict, list or tuple, " f"not {type(self.jsonData)}"

        self.beginResetModel()

        self._rootItem = TreeItem.load(self.jsonData)
        self._rootItem.value_type = type(self.jsonData)
